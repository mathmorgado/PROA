...
CREATE TABLE tb_Pagamento(
	pk_id_Pagamento INT NOT NULL AUTO_INCREMENT UNIQUE,
    Data_Pagamento DATETIME NOT NULL,
    fk_id_Consulta INT NOT NULL,
    Valor_Pagamento FLOAT,
    Metodo_Pagamento ENUM("dinheiro", "credito", "debito"),
    PRIMARY KEY (pk_id_Pagamento),
    CONSTRAINT fk_id_Consulta FOREIGN KEY (fk_id_Consulta) REFERENCES tb_Consulta (pk_id_Consulta)
);
